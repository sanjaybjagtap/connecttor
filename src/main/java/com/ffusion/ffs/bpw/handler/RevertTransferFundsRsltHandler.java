...
/*
 * This class triggers tha bank backend (by calling "TransferFundsResult.processRevertTransferFundsRslt()"
 * to pass back to BPW the results of transfer funds reversal. The handler will be triggered by
 * ETFREVERTRSLTTRN schedule
 */
public class RevertTransferFundsRsltHandler extends TransferFundsBaseHandler implements BPWScheduleHandler
{
    ...
    {
	final String methodName = "RevertTransferFundsRsltHandler.eventHandler:";
    ...
    {
	final String methodName = "RevertTransferFundsRsltHandler.resubmitEventHandler:";
	long start = System.currentTimeMillis();
    int uniqueIndex = PerfLoggerUtil.startPerfLoggingAndGetUniqueIndex(methodName,start);
	...
	// transfer processing to BPW
        _transferFundsRslt.processRevertTransferFundsRslt( batchKey, new Hashtable() );
